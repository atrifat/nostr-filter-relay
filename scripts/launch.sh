...
# bash -c 'while true;do cd "/app/nostr-monitoring-tool/";NODE_ENV=development node "/app/nostr-monitoring-tool/src/index.mjs" >> /app/logs/nmt.log 2>&1;done' & true
...
# bash -c 'while true;do cd "/app/nostr-monitoring-tool/";node "/app/nostr-filter/filter.js" > /dev/null 2>&1;done' & true
